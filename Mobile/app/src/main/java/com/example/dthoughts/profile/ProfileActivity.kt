...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun showEditPostDialog(post: com.example.dthoughts.post.Post) {
    ...
    private fun showDeleteConfirmation(post: com.example.dthoughts.post.Post) {
        android.app.AlertDialog.Builder(this)
    ...
    private fun openPostDetail(post: com.example.dthoughts.post.Post) {
        val intent = Intent(this, PostDetailActivity::class.java)
        intent.putExtra("POST_JSON", com.google.gson.Gson().toJson(post))
        startActivity(intent)
    }

    private fun sharePost(post: com.example.dthoughts.post.Post) {
    ...
    private fun updateUI(user: com.example.dthoughts.profile.User) {
    ...
    private fun sendFollowNotification(targetUserId: Long, currentUser: User) {
        lifecycleScope.launch {
            try {
                val notification = com.example.dthoughts.notification.Notification(
                    userId = targetUserId,
                    type = "FOLLOW",
